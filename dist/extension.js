        ...
        switch (name) {
            ...
            case 'do-compare':
                ...
                if (this._extensionContext.globalState.get('file-to-compare') === undefined) {
                    ...
                    this._vscode.commands.executeCommand("vscode.diff", this._vscode.Uri.parse(this._extensionContext.globalState.get('file-to-compare')), this._vscode.Uri.parse(coComparePath));
                    this._extensionContext.globalState.update('file-to-compare', undefined);
                }
                return;
            default:
...
class WorkingHistoryFiles {
    ...
    getAllFilesRecursively(folder, options) {
        return __awaiter(this, void 0, void 0, function* () {
            let allFiles = [];
            const list = yield this.walk(folder);
            for (let f of list) {
