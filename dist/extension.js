...
const content_provider_1 = __webpack_require__(20);
const uri_service_1 = __webpack_require__(18);
const settings_1 = __webpack_require__(21);
const working_files_history_provider_1 = __webpack_require__(23);
class IntegratorFactory {
    ...
    _createSidebar() {
        return new sidebar_provider_1.SidebarProvider({
            vscode,
            context: this._extensionContext,
            settings: this._getSettings(),
    ...
    _createHistoryPresenterTab() {
        return new working_files_history_provider_1.WorkingFilesHistoryTab({
            vscode,
            app: this,
        });
    }
...
const vscode = __webpack_require__(2);
const getIdentifierStr_1 = __webpack_require__(15);
const working_files_history_provider_1 = __webpack_require__(23);
const working_history_files_1 = __webpack_require__(16);
class SidebarProvider {
    constructor(params) {
        this._mainTab = undefined;
        this._vscode = params.vscode;
    ...
    createNewMainTab(targetFolder) {
        const mainTab = new working_files_history_provider_1.WorkingFilesHistoryTab({
            vscode: this._vscode,
            app: this._app
        });
        ...
        return ((data) => __awaiter(this, void 0, void 0, function* () {
            switch (data.type) {
                ...
                case "settingHistoryIgnoreRemoveItem": {
                    const doRemoveHistItem = yield this._settings.removeHistoryIgnoreItem(data.value);
    ...
    resolveWebviewView(webviewView, ExtensionContext, token) {
        return __awaiter(this, void 0, void 0, function* () {
...
const path = __webpack_require__(6);
const config_1 = __webpack_require__(7);
const diff_presenter_1 = __webpack_require__(17);
...
const constant = __webpack_require__(11);
const path = __webpack_require__(6);
const querystring = __webpack_require__(19);
class UriService {
    constructor(params) {
...
class WorkingFilesHistoryTab {
    constructor(params) {
        this.viewType = "nadi-web-admin";
        this._disposables = [];
        this._windowTab = null;
    ...
    createOrShow(sidebar, targetFolder) {
    ...
    _getHistoryList(targetFolder) {
        if (targetFolder !== undefined) {
            return this.workingHistoryFiles.readHistoryCollections(path.join(config_1.config.localDirectory, 'history', targetFolder));
        }
        else {
            return this.workingHistoryFiles.readHistoryFolder();
        }
    }
    _getTargetFolderData(targetFolder) {
        if (targetFolder !== undefined) {
            return {
    ...
    _getHtmlForWebview(webview, mainApp, targetFolder) {
